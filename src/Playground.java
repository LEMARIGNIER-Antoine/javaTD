...
public class Playground {
                ...
                for (byte element : line.getBytes(StandardCharsets.UTF_8)){
                    switch (element){
                        ...
                        case 'R' : environment.add(new SolidSprite(columnNumber*imageRockWidth,
                            ...
                            break;
                        case 'P' : environment.add(new StaticSprite(columnNumber*imageTrapWidth,
    ...
    public ArrayList<Sprite> getSolidSpriteList(){
        ...
        for (Sprite sprite : environment){ // add Static Sprite to the environment
            if (sprite instanceof SolidSprite || sprite instanceof StaticSprite) solidSpriteArrayList.add(sprite);
        }
